...
import br.com.lampmobile.adapter.historico.HistoricoAdapter;

public abstract class CalculadoraActivity extends AppCompatActivity {

    public abstract void calcular(View view);
