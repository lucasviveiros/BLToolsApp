...
public class ChurrascoActivity extends AppCompatActivity {
    ...
    public void calcular(View view) {
        ...
        ChurrascoHelper helper = new ChurrascoHelper(this);
        SQLiteDatabase db = helper.getReadableDatabase();;
        Map<ChurrascoHelper.Tipo, List<ChurrascoHelper.Churrasco>> mapChurrasco = helper.getItensAtivos(db);

//        List<ChurrascoHelper.Churrasco> itens = mapChurrasco.get(ChurrascoHelper.Tipo.CARNE);
